...
public class MovieController {
    ...
    public MovieController(MovieService movieService, UserService userService, WatchedMovieService watchedMovieService, WatchlistService watchlistService, GenreService genreService) {
    ...
    public ModelAndView getMoviePage(@PathVariable UUID id, @AuthenticationPrincipal UserData userData) {
        ...
        boolean movieIsWatched = watchedMovieService.movieIsWatched(movie, user);
        boolean movieIsInWatchlist = watchlistService.movieIsInWatchlist(movie, user);
